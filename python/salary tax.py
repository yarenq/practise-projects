...
print(f"""Percentage of sales representatives with a gross salary of more than $50000 among sales representatives with a high gross salary level:{really_high/high*100:.2f}%""")
